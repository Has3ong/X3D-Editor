...
MFCApplication1.h
    ...
    여기에는 resource.h를 비롯한 다른 프로젝트별 헤더가 포함되어 있으며 YangJaeApplicationApp 응용 프로그램 클래스가 선언되어 있습니다.

MFCApplication1.cpp
    이는 응용 프로그램 클래스 YangJaeApplicationApp가 포함된 기본 응용 프로그램 소스 파일입니다.
...
YangJaeApplicationDlg.h, YangJaeApplicationDlg.cpp - 대화 상자
    이 파일에는 YangJaeApplicationDlg 클래스가 포함됩니다. 이 클래스는 응용 프로그램의 주 대화 상자에 대한 동작을 정의합니다. 이 대화 상자 템플릿은 MFCApplication1.rc에 있으며, Microsoft Visual C++에서 직접 편집할 수 있습니다.
